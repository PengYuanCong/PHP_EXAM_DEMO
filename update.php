        ...
        <ul class="menu">
            ...
            <li class="menu__item"><a href="#">會員管理</a>
                    <ul class="submenu submenu--block">
                        ...
                        <li><a href="./update.php">會員資料修改</a></li>
                        <li><a href="./delete.php">會員資料刪除</a></li>
                        <li><a href="./logout.php">登出</a></li>
                    </ul>
                </li>
        </ul>
    ...
    <div class="container">
        <div class="sidebar" style="flex-grow: 2;">
            <ul class="menu" style="flex-flow: column wrap;">
                <li class="menu__item" style="display: block;text-align: left"><a href="./update.php">會員資料修改</a></li>
                <li class="menu__item" style="display: block;text-align: left"><a href="./delete.php">會員資料刪除</a></li>
        ...
        <main style="flex-grow: 1">
            ...
            <?php
              ...
              if($result=mysqli_query($conn,$SQL)){
                ...
                echo "<tr><td><h4>會員帳號</h4></td><td><h4>會員信箱</h4></td><td><h4>會員密碼</h4></td><td>";
...
<form action="updateconfirm.php" method="post">
    使用者信箱:<?php echo $email;?></br>
    <input type="text" name="Email" value='<?php echo $email;?>'></br>

    設定新的密碼:<input type="text" name="Password" value='<?php echo $userpassword;?>'></br>
